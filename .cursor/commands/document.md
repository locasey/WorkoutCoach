...
You are updating documentation after code changes. Update CHANGELOG.md, any relevant README.md files and git. 
...
If you're unsure about intent behind a change or user-facing impact, **ask the user** - don't guess. Again update Update CHANGELOG.md, any relevant README.md files and git. 